...
public class AuthService
{
    ...
    private readonly PostgresDatabaseHelper _postgresDbHelper;

    private const string host = "http://localhost:5000/api/auth";

    public AuthService(IConfiguration configuration, EmailService emailService, ILogGeral logGeral, Utilidades utils, PostgresDatabaseHelper postgresDbHelper)
    {
        ...
        _utils = utils;
        _postgresDbHelper = postgresDbHelper;
    }
